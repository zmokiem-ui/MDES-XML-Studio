...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotificatieOverGedownloadeBestandenSturen']" mode="content">
        <tr class="header">
        ...
        <td class="title"><xsl:apply-templates select="//cas:property[cas:key='Onderwerp']/cas:value"/></td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//NotificatieOverGedownloadeBestandenSturen.Aanhef"/><xsl:apply-templates select="//cas:property[cas:key='NaamGebruiker']/cas:value"/>,</p>
          <p>
            <xsl:apply-templates select="//NotificatieOverGedownloadeBestandenSturen.ViaUitwisseling"/>
            <xsl:apply-templates select="//cas:property[cas:key='AantalBestanden']/cas:value"/> 
            <xsl:apply-templates select="//NotificatieOverGedownloadeBestandenSturen.BestandenOntvangen"/>
          </p>
          <p>
          <xsl:apply-templates select="//NotificatieOverGedownloadeBestandenSturen.LogIn"/>
          </p>
          <br />
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//NotificatieOverGedownloadeBestandenSturen.OpenPortaal"/>
            &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotificatieOverGedownloadeBestandenSturen']" mode="plaintext">  

    <xsl:apply-templates select="//cas:property[cas:key='Onderwerp']/cas:value"/>
    <xsl:text xml:space="preserve">
      </xsl:text>
    <xsl:apply-templates select="//NotificatieOverGedownloadeBestandenSturen.Aanhef"/><xsl:apply-templates select="//cas:property[cas:key='NaamGebruiker']/cas:value"/>
    <xsl:text xml:space="preserve">
      </xsl:text>
    <xsl:apply-templates select="//NotificatieOverGedownloadeBestandenSturen.ViaUitwisseling"/>
    <xsl:text xml:space="preserve">

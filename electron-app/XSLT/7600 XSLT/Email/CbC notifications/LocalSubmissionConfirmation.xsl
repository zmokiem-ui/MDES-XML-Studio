...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='LocalSubmissionConfirmation']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
				...
				<xsl:apply-templates select="//LocalSubmissionConfirmation.Titel"/>  
			</td>
      ...
      <tr>
        ...
        <td class="text-highlight">
        	<p>
        		<xsl:apply-templates select="//LocalSubmissionConfirmation.Aanhef" /></p>
        	<p>
        		

				<xsl:apply-templates select="//LocalSubmissionConfirmation.Afgerond"/>  
			...
			<xsl:apply-templates select="//LocalSubmissionConfirmation.OpenPortaalVoorResultaat"/>  
        	...
        	<p class="buttonlink">
        		<a>
        			...
        			&#32;&#32;&#32;&#32;&#32;&#32;
					<xsl:apply-templates select="//LocalSubmissionConfirmation.OpenPortaal"/>  
					&#32;&#32;&#32;&#32;&#32;&#32;&#160;
        		</a></p>
        	<p>
			
			<xsl:apply-templates select="//LocalSubmissionConfirmation.DocumentenOpgeslagen"/>  
			</p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
	...
	<xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='LocalSubmissionConfirmation']" mode="plaintext">


<xsl:apply-templates select="//LocalSubmissionConfirmation.Titel"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//LocalSubmissionConfirmation.Aanhef" />
<xsl:apply-templates select="//LocalSubmissionConfirmation.Afgerond"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//LocalSubmissionConfirmation.Verdrag"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='Verdrag']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//LocalSubmissionConfirmation.Jurisdictie"/>
<xsl:text xml:space="preserve">
      </xsl:text>
...
<xsl:apply-templates select="//LocalSubmissionConfirmation.TypeLevering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='TypeLeveringLabelNL']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//LocalSubmissionConfirmation.Levering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//LocalSubmissionConfirmation.OpenPortaalVoorResultaat"/>
<xsl:text xml:space="preserve">

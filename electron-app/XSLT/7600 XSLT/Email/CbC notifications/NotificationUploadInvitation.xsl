...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotificationUploadInvitation']" mode="content">
        ...
        <td class="title"><xsl:apply-templates select="//NotificationUploadInvitation.Titel"/></td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//NotificationUploadInvitation.Aanhef"/></p>
          
          <p>
            <xsl:apply-templates select="//NotificationUploadInvitation.Tekst"/>
          </p>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotificationUploadInvitation']" mode="plaintext">

      <xsl:apply-templates select="//NotificationUploadInvitation.Titel"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//NotificationUploadInvitation.Aanhef"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//NotificationUploadInvitation.Tekst"/>
<xsl:text xml:space="preserve">

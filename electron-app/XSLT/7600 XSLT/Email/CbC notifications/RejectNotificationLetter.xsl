...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='RejectNotificationLetter']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
				...
				<xsl:apply-templates select="//RejectNotificationLetter.Titel"/>  
			</td>
      ...
      <tr>
        ...
        <td class="text-highlight">
        	<p>
        		<xsl:apply-templates select="//RejectNotificationLetter.Aanhef" />
        		<xsl:apply-templates select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
        	<p>
        		

				<xsl:apply-templates select="//RejectNotificationLetter.Afgerond"/>  
			...
			<xsl:apply-templates select="//RejectNotificationLetter.OpenPortaalVoorResultaat"/>  

			</p>
			<p>
			<xsl:apply-templates select="//RejectNotificationLetter.Intro"/>  
        	...
        	<p class="buttonlink">
        		<a>
        			...
        			&#32;&#32;&#32;&#32;&#32;&#32;
					<xsl:apply-templates select="//RejectNotificationLetter.OpenPortaal"/>  
					&#32;&#32;&#32;&#32;&#32;&#32;&#160;
        		</a></p>
        	<p>
			
			<xsl:apply-templates select="//RejectNotificationLetter.DocumentenOpgeslagen"/>  
			</p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
	...
	<xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='RejectNotificationLetter']" mode="plaintext">
...
<xsl:apply-templates select="//RejectNotificationLetter.Verdrag"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='Verdrag']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//RejectNotificationLetter.Jurisdictie"/>
<xsl:text xml:space="preserve">
      </xsl:text>
...
<xsl:apply-templates select="//RejectNotificationLetter.TypeLevering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='TypeLeveringLabelNL']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//RejectNotificationLetter.Levering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//RejectNotificationLetter.OpenPortaalVoorResultaat"/>
<xsl:text xml:space="preserve">

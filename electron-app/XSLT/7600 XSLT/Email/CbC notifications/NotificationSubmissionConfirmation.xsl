...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotificationSubmissionConfirmation']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
				...
				<xsl:apply-templates select="//NotificationSubmissionConfirmation.Titel"/>  
			</td>
      ...
      <tr>
        ...
        <td class="text-highlight">
        	<p>
        		<xsl:apply-templates select="//NotificationSubmissionConfirmation.Aanhef" />
        		<xsl:apply-templates select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
        	<p>
        		

				<xsl:apply-templates select="//NotificationSubmissionConfirmation.Afgerond"/>  
			...
			<xsl:apply-templates select="//NotificationSubmissionConfirmation.Intro"/>  
			<br />
			</p>
			<p>
			

			<xsl:apply-templates select="//NotificationSubmissionConfirmation.Text"/>  
			<br />
			</p>
        	<p class="buttonlink">
        		<a>
        			...
        			&#32;&#32;&#32;&#32;&#32;&#32;
					<xsl:apply-templates select="//NotificationSubmissionConfirmation.OpenPortaal"/>  
					&#32;&#32;&#32;&#32;&#32;&#32;&#160;
        		</a></p>
        	<p>
			
			<xsl:apply-templates select="//NotificationSubmissionConfirmation.DocumentenOpgeslagen"/>  
			</p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
	...
	<xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotificationSubmissionConfirmation']" mode="plaintext">
...
<xsl:apply-templates select="//NotificationSubmissionConfirmation.Verdrag"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='Verdrag']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//NotificationSubmissionConfirmation.Jurisdictie"/>
<xsl:text xml:space="preserve">
      </xsl:text>
...
<xsl:apply-templates select="//NotificationSubmissionConfirmation.TypeLevering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='TypeLeveringLabelNL']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//NotificationSubmissionConfirmation.Levering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//NotificationSubmissionConfirmation.OpenPortaalVoorResultaat"/>
<xsl:text xml:space="preserve">
      </xsl:text>

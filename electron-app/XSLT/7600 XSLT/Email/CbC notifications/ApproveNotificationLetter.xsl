...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='ApproveNotificationLetter']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
				...
				<xsl:apply-templates select="//ApproveNotificationLetter.Titel"/>  
			</td>
      ...
      <tr>
        ...
        <td class="text-highlight">
        	<p>
        		<xsl:apply-templates select="//ApproveNotificationLetter.Aanhef" />
        		<xsl:apply-templates select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
        	<p>
        		

				<xsl:apply-templates select="//ApproveNotificationLetter.Afgerond"/>  
			...
			<xsl:apply-templates select="//ApproveNotificationLetter.OpenPortaalVoorResultaat"/>  

			</p>
			<p>
			<xsl:apply-templates select="//ApproveNotificationLetter.Intro"/>  
			<br />
			</p>
			<p>
			

			<xsl:apply-templates select="//ApproveNotificationLetter.Text"/>  
			<br />
			</p>
        	<p class="buttonlink">
        		<a>
        			...
        			&#32;&#32;&#32;&#32;&#32;&#32;
					<xsl:apply-templates select="//ApproveNotificationLetter.OpenPortaal"/>  
					&#32;&#32;&#32;&#32;&#32;&#32;&#160;
        		</a></p>
        	<p>
			
			<xsl:apply-templates select="//ApproveNotificationLetter.DocumentenOpgeslagen"/>  
			</p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
	...
	<xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='ApproveNotificationLetter']" mode="plaintext">
...
<xsl:apply-templates select="//ApproveNotificationLetter.Verdrag"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='Verdrag']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//ApproveNotificationLetter.Jurisdictie"/>
<xsl:text xml:space="preserve">
      </xsl:text>
...
<xsl:apply-templates select="//ApproveNotificationLetter.TypeLevering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='TypeLeveringLabelNL']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//ApproveNotificationLetter.Levering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//ApproveNotificationLetter.OpenPortaalVoorResultaat"/>
<xsl:text xml:space="preserve">

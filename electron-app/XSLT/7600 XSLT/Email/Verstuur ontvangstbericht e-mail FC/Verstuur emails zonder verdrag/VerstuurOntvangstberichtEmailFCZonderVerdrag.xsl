...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurOntvangstberichtEmailFCZonderVerdrag']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title"><xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.Titel"/>  </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.IngediendBijAuthoriteit"/> 
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.DatumIngediend"/> 
            <span class="highlight"
              ><xsl:apply-templates  select="//cas:property[cas:key='DatumIngediendFormaat']/cas:value" /></span
            >
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.TypeLevering"/> 
            <span class="highlight"
              ><xsl:apply-templates  select="//cas:property[cas:key='TypeLevering']/cas:value" mode="translate-value" /></span
            ><br />
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.Belastingjaar"/> 
            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Belastingjaar']/cas:value" /></span>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.IngediendBijAuthoriteitDoorgegeven"/> 
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.IngeslotenPDF"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
          <p>
            <span class="highlight">
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.Belangrijk"/>
            </span>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.Informatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    </xsl:template>
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurOntvangstberichtEmailFCZonderVerdrag']" mode="plaintext">


<xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.Titel"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurOntvangstberichtEmailFCZonderVerdrag.IngediendBijAuthoriteit"/>
<xsl:text xml:space="preserve">

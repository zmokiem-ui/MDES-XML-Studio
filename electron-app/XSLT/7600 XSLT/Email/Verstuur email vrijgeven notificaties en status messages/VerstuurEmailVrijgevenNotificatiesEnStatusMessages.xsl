...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailVrijgevenNotificatiesEnStatusMessages']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
         <xsl:apply-templates select="//VerstuurEmailVrijgevenNotificatiesEnStatusMessages.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//VerstuurEmailVrijgevenNotificatiesEnStatusMessages.Aanhef"/> 
          <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailVrijgevenNotificatiesEnStatusMessages.Vanuit"/>  
            <xsl:apply-templates  select="//cas:property[cas:key='DoorgeeflandNaam']/cas:value"  mode="translate-value"/> 
            <xsl:apply-templates select="//VerstuurEmailVrijgevenNotificatiesEnStatusMessages.NotificatieOntvangen"/> 
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailVrijgevenNotificatiesEnStatusMessages.Verdrag"/>  
            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" /></span>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailVrijgevenNotificatiesEnStatusMessages.Dossiernaam"/>  
            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Dossiernaam']/cas:value" /></span>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailVrijgevenNotificatiesEnStatusMessages.NotificatieOpgeslagen"/>  
            <br />
            <xsl:apply-templates select="//VerstuurEmailVrijgevenNotificatiesEnStatusMessages.KlikInTeZien"/>  
          </p>
          <p class="buttonlink">
            <a>
              <xsl:attribute name="href"><xsl:apply-templates select="//cas:property[cas:key='PortaalNotificatiesLink']/cas:value"/></xsl:attribute>
              &#32;&#32;&#32;&#32;&#32;&#32;
              <xsl:apply-templates select="//VerstuurEmailVrijgevenNotificatiesEnStatusMessages.OpenPortaal"/>  
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailVrijgevenNotificatiesEnStatusMessages']" mode="plaintext">

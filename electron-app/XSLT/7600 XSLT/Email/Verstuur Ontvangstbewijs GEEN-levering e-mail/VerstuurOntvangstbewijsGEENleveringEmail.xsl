...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurOntvangstbewijsGEENleveringEmail']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
         <xsl:apply-templates select="//VerstuurOntvangstbewijsGEENleveringEmail.Titel"/> 
         </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//VerstuurOntvangstbewijsGEENleveringEmail.Aanhef"/> 
           <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
          <xsl:apply-templates select="//VerstuurOntvangstbewijsGEENleveringEmail.GeenGegevens"/> 
            
            <xsl:apply-templates  select="//cas:property[cas:key='Belastingjaar']/cas:value" />.
          </p>
          <p>
          <xsl:apply-templates select="//VerstuurOntvangstbewijsGEENleveringEmail.DatumIngediend"/>
            
            <span class="highlight"
              ><xsl:apply-templates  select="//cas:property[cas:key='DatumIngediendFormaat']/cas:value" /></span
            ><br />
            <xsl:apply-templates select="//VerstuurOntvangstbewijsGEENleveringEmail.Belastingjaar"/>

            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Belastingjaar']/cas:value" /></span>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstbewijsGEENleveringEmail.IngeslotenPDF"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            <xsl:apply-templates select="//VerstuurOntvangstbewijsGEENleveringEmail.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
          <p>
            <span class="highlight">
            <xsl:apply-templates select="//VerstuurOntvangstbewijsGEENleveringEmail.Belangrijk"/> 
            </span>
            <xsl:apply-templates select="//VerstuurOntvangstbewijsGEENleveringEmail.Informatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    </xsl:template>
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurOntvangstbewijsGEENleveringEmail']" mode="plaintext">

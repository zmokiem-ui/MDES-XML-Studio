    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='BerichtNaarCompetentAuthoritySturen']" mode="content">
      ...
      <tr>
        ...
        <td class="text-highlight">
          ...
          <p>
            Er staat een MoU bestand klaar om gedownload te worden. Hiervoor
            dient u in te loggen in het
            <a href=" https://eoi.belastingdienst.cw/MDES/PortaalAEOI/"
              >MDES portaal</a
            >
            en vervolgens via de tab "Downloads" op het bestand te klikken.
          </p>
          <p>Hierna kunt op de taak "MoU bestand downloaden" klikken.</p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    </xsl:template>

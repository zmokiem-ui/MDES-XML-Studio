...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='BerichtBeoordelingAanvraagWijzigenVerdragVersturenINCOMPLETE']" mode="content">
        <tr class="header">
        ...
        <td class="title"><xsl:apply-templates select="//BerichtBeoordelingAanvraagWijzigenVerdragVersturenINCOMPLETE.Titel"/></td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
            <xsl:apply-templates select="//BerichtBeoordelingAanvraagWijzigenVerdragVersturenINCOMPLETE.AanvraagAfgewezen"/>
          </p>
          <p class="buttonlink">
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//BerichtBeoordelingAanvraagWijzigenVerdragVersturenINCOMPLETE.OpenPortaal"/>
            &#32;&#32;&#32;&#32;&#32;&#32;&#160;
            </a>
          </p>
          <p>
            <span class="highlight"
              > <xsl:apply-templates select="//BerichtBeoordelingAanvraagWijzigenVerdragVersturenINCOMPLETE.ToelichtingVerzoek"/></span
            >
          </p>
      ...
      <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='BerichtBeoordelingAanvraagWijzigenVerdragVersturenINCOMPLETE']" mode="plaintext">
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//BerichtBeoordelingAanvraagWijzigenVerdragVersturenINCOMPLETE.Titel"/>
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//BerichtBeoordelingAanvraagWijzigenVerdragVersturenINCOMPLETE.AanvraagAfgewezen"/>
      <xsl:text xml:space="preserve">
      ...
      <xsl:apply-templates select="//BerichtBeoordelingAanvraagWijzigenVerdragVersturenINCOMPLETE.ToelichtingVerzoek"/>
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//cas:property[cas:key='RedenAfwijzenAanvraag']/cas:value"/>
    </xsl:template>

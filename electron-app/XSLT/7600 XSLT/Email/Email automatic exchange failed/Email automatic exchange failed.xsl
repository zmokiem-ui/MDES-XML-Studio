...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailAutomaticExchangeFailed']" mode="content">
        <tr class="header">
        ...
        <td class="title">Email automatic exchange failed</td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>The CTS server is down</p>
       </td>
      </tr>
    </xsl:template>
    
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailAutomaticExchangeFailed']" mode="plaintext">

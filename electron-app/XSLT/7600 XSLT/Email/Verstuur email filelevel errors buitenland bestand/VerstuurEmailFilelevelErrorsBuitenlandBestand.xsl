...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailFilelevelErrorsBuitenlandBestand']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
          <xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
          <xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.Vanuit"/> <xsl:apply-templates  select="//cas:property[cas:key='DoorgeeflandNaam']/cas:value" mode="translate-value"/> 
             <xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.FoutenBekijken"/>
             
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.Verdragen"/>

            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" /></span>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.Dossiernaam"/>

            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Dossiernaam']/cas:value" /></span>
          </p>
          <p>
          <xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.InPaneelOpgeslagen"/>
            <br />
            
            <xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.KlikOpKnop"/>
          </p>
          <p class="buttonlink">
            <a>
              <xsl:attribute name="href"><xsl:apply-templates select="//cas:property[cas:key='PortaalNotificatiesLink']/cas:value"/></xsl:attribute>
              &#32;&#32;&#32;&#32;&#32;&#32;
              <xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailFilelevelErrorsBuitenlandBestand']" mode="plaintext">
...
<xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.Vanuit"/>
<xsl:text xml:space="preserve">
      </xsl:text>
...
<xsl:apply-templates  select="//cas:property[cas:key='Dossiernaam']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailFilelevelErrorsBuitenlandBestand.InPaneelOpgeslagen"/>
<xsl:text xml:space="preserve">

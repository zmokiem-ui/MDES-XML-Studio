...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailNaarVorigEmailadres']" mode="content">
        <tr class="header">
        ...
        <xsl:choose>
          <xsl:when test="//cas:property[cas:key='FormeleNaam']/cas:value=''">
            <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.Titel"/>
          </xsl:when>
          
          <xsl:otherwise>
           <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.TitelIncFormeleNaam"/>
          </xsl:otherwise>
        </xsl:choose>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.Aanhef"/><xsl:apply-templates select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
            <xsl:choose>
              <xsl:when test="//cas:property[cas:key='FormeleNaam']/cas:value=''">
                <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.AccountgegevensGewijzigd"/>
              </xsl:when>
              
              <xsl:otherwise>
              <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.AccountgegevensGewijzigdIncFormeleNaam"/>
              </xsl:otherwise>
            </xsl:choose>
          ...
          <p>
                  <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.NieuweEmailIs"/> <xsl:apply-templates select="//cas:property[cas:key='E_mailAdres']/cas:value" />.</p>

          <p>
            <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.GegevensNietZelfGewijzigd"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.OpenPortaal"/>
            &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailNaarVorigEmailadres']" mode="plaintext">

      
    <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.Titel"/> 
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.Aanhef"/>
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.AccountgegevensGewijzigd"/><xsl:apply-templates select="//cas:property[cas:key='FormeleNaam']/cas:value"/>
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//VerstuurEmailNaarVorigEmailadres.NieuweEmailIs"/>
      <xsl:text xml:space="preserve">
      </xsl:text>

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          ...
          <xsl:when test="//cas:property[cas:key='FormeleNaam']/cas:value=''">
            <xsl:apply-templates select="//VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee.Titel"/>
          </xsl:when>
          
          <xsl:otherwise>
           <xsl:apply-templates select="//VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee.TitelIncFormeleNaam"/>
          </xsl:otherwise>
        </xsl:choose>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee.Aanhef"/> 
          <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
            <xsl:choose>
              <xsl:when test="//cas:property[cas:key='FormeleNaam']/cas:value=''">
                <xsl:apply-templates select="//VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee.AccountgegevensGewijzigd"/>
              </xsl:when>
              
              <xsl:otherwise>
              <xsl:apply-templates select="//VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee.AccountgegevensGewijzigdIncFormeleNaam"/>
              </xsl:otherwise>
            </xsl:choose>
          ...
          <p>
            <xsl:apply-templates select="//VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee.GegevensNietZelfGewijzigd"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee.OpenPortaal"/>
            &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee']" mode="plaintext">
...
<xsl:apply-templates select="//VerstuurEmailBevestigingProfielGewijzigdEmailGewijzigdNee.AccountgegevensGewijzigd"/><xsl:apply-templates select="//cas:property[cas:key='FormeleNaam']/cas:value"/>
<xsl:text xml:space="preserve">
      </xsl:text>

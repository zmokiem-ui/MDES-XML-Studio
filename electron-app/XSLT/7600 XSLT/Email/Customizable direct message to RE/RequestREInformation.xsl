...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='RequestREInformation']" mode="content">
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//RequestREInformation.Aanhef"/></p>
          <p>
            <xsl:apply-templates select="//RequestREInformation.AanvraagVoorGebruik"/>
          </p>
          <p>
            <xsl:apply-templates select="//RequestREInformation.Tekst"/>
          </p>
        
        
          <p>
            <span class="highlight">
              <xsl:apply-templates select="//RequestREInformation.Belangrijk"/>
             </span>
             <xsl:apply-templates select="//RequestREInformation.Informatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='RequestREInformation']" mode="plaintext">

      <xsl:apply-templates select="//RequestREInformation.Titel"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//RequestREInformation.Aanhef"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//RequestREInformation.AanvraagVoorGebruik"/>
<xsl:text xml:space="preserve">
...
<xsl:text xml:space="preserve">
      ...
      <xsl:apply-templates select="//RequestREInformation.Bevestig"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//RequestREInformation.LinkWerktNiet"/>
<xsl:text xml:space="preserve">
</xsl:text>

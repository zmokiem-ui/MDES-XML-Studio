...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotifyRECRSReporting']" mode="content">
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//NotifyRECRSReporting.Aanhef"/></p>
          <p>
            <xsl:apply-templates select="//NotifyRECRSReporting.AanvraagVoorGebruik"/>
          </p>
          <p>
            <xsl:apply-templates select="//NotifyRECRSReporting.Tekst"/>
          </p>
        
        
          <p>
            <span class="highlight">
              <xsl:apply-templates select="//NotifyRECRSReporting.Belangrijk"/>
             </span>
             <xsl:apply-templates select="//NotifyRECRSReporting.Informatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotifyRECRSReporting']" mode="plaintext">

      <xsl:apply-templates select="//NotifyRECRSReporting.Titel"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//NotifyRECRSReporting.Aanhef"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//NotifyRECRSReporting.AanvraagVoorGebruik"/>
<xsl:text xml:space="preserve">
...
<xsl:text xml:space="preserve">
      ...
      <xsl:apply-templates select="//NotifyRECRSReporting.Bevestig"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//NotifyRECRSReporting.LinkWerktNiet"/>
<xsl:text xml:space="preserve">
</xsl:text>

...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='MOUBerichtNaarCompetentAuthority']" mode="content">
        ...
        <td class="title"><xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.Titel"/></td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.Aanhef"/></p>
          <p>
            <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.AanvraagVoorGebruik"/>
          </p>
          <p>
            <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.KlikKnop"/>
          </p>
          <p class="buttonlink">
            <a>
              <xsl:attribute name="href"><xsl:apply-templates select="//cas:property[cas:key='Activatielink']/cas:value"/></xsl:attribute>
              &#32;&#32;&#32;&#32;&#32;&#32;<xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.Bevestig"/>&#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
          <p>
          <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.LinkWerktNiet"/>
            
            <span class="highlight"><xsl:value-of  select="//cas:property[cas:key='Activeringscode']/cas:value" /></span>
          </p>
          <p>
            <span class="highlight">
              <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.Belangrijk"/>
             </span>
             <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.Informatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='MOUBerichtNaarCompetentAuthority']" mode="plaintext">

      <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.Titel"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.Aanhef"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.AanvraagVoorGebruik"/>
<xsl:text xml:space="preserve">
...
<xsl:text xml:space="preserve">
      ...
      <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.Bevestig"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//MOUBerichtNaarCompetentAuthority.LinkWerktNiet"/>
<xsl:text xml:space="preserve">

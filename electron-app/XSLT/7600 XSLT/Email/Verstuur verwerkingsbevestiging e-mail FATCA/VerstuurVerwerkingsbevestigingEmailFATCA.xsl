...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurVerwerkingsbevestigingEmailFATCA']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
         <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.Titel"/> 
         </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.Aanhef"/>  <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
          <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.LeveringBezorgd"/> 
            
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.Verdrag"/> 
            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Verdragen']/cas:value"  mode="translate-value"/></span>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.Jurisdictie"/> 
            ...
            ><br />
            <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.DatumBezorging"/> 
            <span class="highlight"
              ><xsl:apply-templates  select="//cas:property[cas:key='DatumBezorgdFormaat']/cas:value" /></span
            >
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.TypeLevering"/> 
            <span class="highlight"
              ><xsl:apply-templates  select="//cas:property[cas:key='TypeLeveringLabelNL']/cas:value" /></span
            ><br />
            <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.Belastingjaar"/> 
            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Belastingjaar']/cas:value" /></span>
          </p>
          <br />
          <p>
            <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.IngeslotenPDF"/> 
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
          <p>
            <span class="highlight">
            <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.Belangrijk"/>
            </span>
            <xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.Informatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    </xsl:template>
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurVerwerkingsbevestigingEmailFATCA']" mode="plaintext">


<xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.Titel"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.Aanhef"/>  <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.LeveringBezorgd"/>
<xsl:text xml:space="preserve">
...
<xsl:apply-templates  select="//cas:property[cas:key='DatumBezorgdFormaat']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurVerwerkingsbevestigingEmailFATCA.TypeLevering"/>
<xsl:text xml:space="preserve">

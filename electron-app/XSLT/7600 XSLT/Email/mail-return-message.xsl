...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template match="/">
		<cas:eventResponse>
		    <cas:caseId/>
		    <cas:dataset id="messagedata">
		        <cas:label>messagedata</cas:label>
		        <cas:property>
		            <cas:key>messageSubject</cas:key>
		            <cas:value><xsl:value-of select="$messageSubject"/></cas:value>
		        </cas:property>
		   		<cas:property>
		            <cas:key>messageHTML</cas:key>
		            <cas:value><xsl:value-of select="$messageHTML"/></cas:value>
		        </cas:property>   
		   		<cas:property>
		            <cas:key>messagePlainText</cas:key>
		            <cas:value><xsl:value-of select="$messagePlainText"/></cas:value>
		        </cas:property>   
    		</cas:dataset>
		</cas:eventResponse>
	</xsl:template>

...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='ActiveringscodeVersturenSecureMethod']" mode="content">
     
        <tr class="header">
        <td width="55" class="logo">
          <img>
            <xsl:apply-templates select="." mode="LogoURL" />
            <xsl:apply-templates select="." mode="mailTextLogo" />
          </img>
        </td>
        <td class="title"><xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.Titel"/></td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.Aanhef"/></p>
          <p>
            <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.AanvraagVoorGebruik"/>
          </p>
          <p>
            <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.KlikKnop"/>
          </p>
          <p class="buttonlink">
            <a>
              <xsl:attribute name="href"><xsl:apply-templates select="//cas:property[cas:key='Activatielink']/cas:value"/></xsl:attribute>
              &#32;&#32;&#32;&#32;&#32;&#32;<xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.Bevestig"/>&#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
          <p>
          <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.LinkWerktNiet"/>
            
            <span class="highlight"><xsl:value-of  select="//cas:property[cas:key='Activeringscode']/cas:value" /></span>
          </p>
          <p>
            <span class="highlight">
              <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.Belangrijk"/>
             </span>
             <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.Informatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='ActiveringscodeVersturenSecureMethod']" mode="plaintext">

      <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.Titel"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.Aanhef"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.AanvraagVoorGebruik"/>
<xsl:text xml:space="preserve">
...
<xsl:text xml:space="preserve">
      ...
      <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.Bevestig"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//ActiveringscodeVersturenSecureMethod.LinkWerktNiet"/>
<xsl:text xml:space="preserve">

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='UserStartedAuditCase']" mode="content">
        <tr class="header">
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//UserStartedAuditCase.Aanhef"/>
          </p>
          <p>
          <xsl:apply-templates select="//UserStartedAuditCase.AdministratiefGebruik"/>
            
            <xsl:apply-templates  select="//cas:property[cas:key='TIN']/cas:value" />
             <xsl:apply-templates select="//UserStartedAuditCase.HasBeenUpdated"/>
          </p>
          <p>
            <xsl:apply-templates select="//UserStartedAuditCase.DetailsOfAdministrator"/> <xsl:apply-templates  select="//cas:property[cas:key='Voornaam']/cas:value" />
          ...
          <p>
          <xsl:apply-templates select="//UserStartedAuditCase.ConfirmIdentity"/>
            <br />
            <xsl:apply-templates select="//UserStartedAuditCase.KlikOpKnop"/>
          ...
          <p class="buttonlink">
            <a>
              ...
              &#32;&#32;&#32;&#32;&#32;&#32;
              <xsl:apply-templates select="//UserStartedAuditCase.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='UserStartedAuditCase']" mode="plaintext">
...
<xsl:apply-templates select="//UserStartedAuditCase.DetailsOfAdministrator"/> 
<xsl:text xml:space="preserve">
      </xsl:text>

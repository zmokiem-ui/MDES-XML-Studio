...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='AuditorAssignedToCase']" mode="content">
        <tr class="header">
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//AuditorAssignedToCase.Aanhef"/>
          </p>
          <p>
          <xsl:apply-templates select="//AuditorAssignedToCase.TheUserHas"/>
            
            <xsl:apply-templates  select="//cas:property[cas:key='TIN']/cas:value" />
             <xsl:apply-templates select="//AuditorAssignedToCase.StartedTheAudit"/>
          </p>
          <p>
            <xsl:apply-templates select="//AuditorAssignedToCase.DetailsOfAdministrator"/> <xsl:apply-templates  select="//cas:property[cas:key='Voornaam']/cas:value" />
          ...
          <p>
            <xsl:apply-templates select="//AuditorAssignedToCase.DetailsOfAudit"/>
          ...
          <p>
          <xsl:apply-templates select="//AuditorAssignedToCase.ConfirmIdentity"/>
            <br />
            </p>
            <p>
            <br />
            <xsl:apply-templates select="//AuditorAssignedToCase.KlikOpKnop"/>
          ...
          <p class="buttonlink">
            <a>
              ...
              &#32;&#32;&#32;&#32;&#32;&#32;
              <xsl:apply-templates select="//AuditorAssignedToCase.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='AuditorAssignedToCase']" mode="plaintext">
...
<xsl:apply-templates select="//AuditorAssignedToCase.AdministratiefGebruik"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates  select="//cas:property[cas:key='TIN']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//AuditorAssignedToCase.HasBeenUpdated"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//AuditorAssignedToCase.DetailsOfAdministrator"/> 
<xsl:text xml:space="preserve">
      </xsl:text>

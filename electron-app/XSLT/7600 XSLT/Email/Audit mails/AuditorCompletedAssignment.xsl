...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='AuditorCompletedAssignment']" mode="content">
        <tr class="header">
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//AuditorCompletedAssignment.Aanhef"/>
          </p>
          <p>
          <xsl:apply-templates select="//AuditorCompletedAssignment.AdministratiefGebruik"/>
            
            <xsl:apply-templates  select="//cas:property[cas:key='TIN']/cas:value" />
             <xsl:apply-templates select="//AuditorCompletedAssignment.HasBeenUpdated"/>
          </p>
          <p>
            <xsl:apply-templates select="//AuditorCompletedAssignment.DetailsOfAdministrator"/> <xsl:apply-templates  select="//cas:property[cas:key='Voornaam']/cas:value" />
          ...
          <p>
            <xsl:apply-templates select="//AuditorCompletedAssignment.DetailsOfAdministrator"/>
          ...
          <p>
          <xsl:apply-templates select="//AuditorCompletedAssignment.ConfirmIdentity"/>
            <br />
            <xsl:apply-templates select="//AuditorCompletedAssignment.KlikOpKnop"/>
          ...
          <p class="buttonlink">
            <a>
              ...
              &#32;&#32;&#32;&#32;&#32;&#32;
              <xsl:apply-templates select="//AuditorCompletedAssignment.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='AuditorCompletedAssignment']" mode="plaintext">

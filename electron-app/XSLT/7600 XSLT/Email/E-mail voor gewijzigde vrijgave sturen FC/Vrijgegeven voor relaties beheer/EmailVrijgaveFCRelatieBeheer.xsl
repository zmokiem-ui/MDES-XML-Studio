...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveFCRelatieBeheer']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//EmailVrijgaveFCRelatieBeheer.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//EmailVrijgaveFCRelatieBeheer.Aanhef"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCRelatieBeheer.ReleaseStatus"/>        
			<xsl:apply-templates select="//EmailVrijgaveFCRelatieBeheer.Mogelijkheid"/>
          </p>
          ...
          <p class="buttonlink">
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//EmailVrijgaveFCRelatieBeheer.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
     ...
     <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveFCRelatieBeheer']" mode="plaintext">

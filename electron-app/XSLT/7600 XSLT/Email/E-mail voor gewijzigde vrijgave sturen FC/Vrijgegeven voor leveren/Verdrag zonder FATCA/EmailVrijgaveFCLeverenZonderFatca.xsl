...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveFCLeverenZonderFatca']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//EmailVrijgaveFCLeverenZonderFatca.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//EmailVrijgaveFCLeverenZonderFatca.Aanhef"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCLeverenZonderFatca.ReleaseStatus"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCLeverenZonderFatca.Mogelijkheid"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//EmailVrijgaveFCLeverenZonderFatca.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCLeverenZonderFatca.Beheren"/>
          </p>
     ...
     <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveFCLeverenZonderFatca']" mode="plaintext">

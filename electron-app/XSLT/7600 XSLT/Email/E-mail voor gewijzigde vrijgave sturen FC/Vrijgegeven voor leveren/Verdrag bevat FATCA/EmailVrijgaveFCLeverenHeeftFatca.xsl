...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveFCLeverenHeeftFatca']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//EmailVrijgaveFCLeverenHeeftFatca.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//EmailVrijgaveFCLeverenHeeftFatca.Aanhef"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCLeverenHeeftFatca.ReleaseStatus"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCLeverenHeeftFatca.Mogelijkheid"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//EmailVrijgaveFCLeverenHeeftFatca.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCLeverenHeeftFatca.Beheren"/>
          </p>
     ...
     <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveFCLeverenHeeftFatca']" mode="plaintext">

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveFCNietVrijgeven']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//EmailVrijgaveFCNietVrijgeven.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//EmailVrijgaveFCNietVrijgeven.Aanhef"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCNietVrijgeven.ReleaseStatus"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCNietVrijgeven.Mogelijkheid"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveFCNietVrijgeven.Emailnotificatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    </xsl:template>
     <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveFCNietVrijgeven']" mode="plaintext">

...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotificationUploadReminder']" mode="content">
        ...
        <td class="title"><xsl:apply-templates select="//NotificationUploadReminder.Titel"/></td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//NotificationUploadReminder.Aanhef"/></p>
          
          <p>
            <xsl:apply-templates select="//NotificationUploadReminder.Tekst"/>
          </p>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='NotificationUploadReminder']" mode="plaintext">

      <xsl:apply-templates select="//NotificationUploadReminder.Titel"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//NotificationUploadReminder.Aanhef"/>
<xsl:text xml:space="preserve">
</xsl:text>
      <xsl:apply-templates select="//NotificationUploadReminder.Tekst"/>
<xsl:text xml:space="preserve">

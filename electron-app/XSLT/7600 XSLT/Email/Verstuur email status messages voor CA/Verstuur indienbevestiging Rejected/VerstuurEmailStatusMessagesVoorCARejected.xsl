...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailStatusMessagesVoorCARejected']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
         <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p><xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.NotificatieOntvangen"/>
            
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.Verdrag"/> <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" /></span>
          </p>
          <br />
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.OntvangenVan"/>
            ...
            ><br />
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.Status"/>
            <span class="highlight"
              ><xsl:apply-templates  select="//cas:property[cas:key='ValidationResultStatus']/cas:value" /></span
            >
          </p>
          <br />
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.NotificatieOpgeslagen"/>
            <br />
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.KlikInTeZien"/>
          </p>
          <p class="buttonlink">
            <a>
              <xsl:attribute name="href"><xsl:apply-templates select="//cas:property[cas:key='PortaalNotificatiesLink']/cas:value"/></xsl:attribute>
              &#32;&#32;&#32;&#32;&#32;&#32;
              <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailStatusMessagesVoorCARejected']" mode="plaintext">
...
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.NotificatieOntvangen"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.Verdrag"/> <xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.OntvangenVan"/>
<xsl:text xml:space="preserve">
...
<xsl:apply-templates  select="//cas:property[cas:key='ValidationResultStatus']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCARejected.NotificatieOpgeslagen"/>
<xsl:text xml:space="preserve">

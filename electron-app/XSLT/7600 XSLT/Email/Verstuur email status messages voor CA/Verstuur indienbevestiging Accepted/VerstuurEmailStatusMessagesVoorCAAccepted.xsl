...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailStatusMessagesVoorCAAccepted']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
          <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.NotificatieOntvangen"/>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.Verdrag"/> <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" /></span>
          </p>
          <br />
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.OntvangenVan"/>
            ...
            ><br />
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.Status"/>
            <span class="highlight"
          ...
          <br />
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.NotificatieOpgeslagen"/>
            <br />
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.KlikInTeZien"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.OpenPortaal"/>
            &#32;&#32;&#32;&#32;&#32;&#32;&#160;
            </a>
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailStatusMessagesVoorCAAccepted']" mode="plaintext">
...
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.NotificatieOntvangen"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.Verdrag"/><xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorCAAccepted.OntvangenVan"/>
<xsl:text xml:space="preserve">

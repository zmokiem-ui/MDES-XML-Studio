...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveCBCRelatieBeheer']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//EmailVrijgaveCBCRelatieBeheer.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//EmailVrijgaveCBCRelatieBeheer.Aanhef"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveCBCRelatieBeheer.ReleaseStatus"/>
   

          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveCBCRelatieBeheer.Mogelijkheid"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//EmailVrijgaveCBCRelatieBeheer.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
     ...
     <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveCBCRelatieBeheer']" mode="plaintext">

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveCBCNietVrijgeven']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//EmailVrijgaveCBCNietVrijgeven.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//EmailVrijgaveCBCNietVrijgeven.Aanhef"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveCBCNietVrijgeven.ReleaseStatus"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveCBCNietVrijgeven.Mogelijkheid"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveCBCNietVrijgeven.Emailnotificatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    </xsl:template>
     <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveCBCNietVrijgeven']" mode="plaintext">

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveCBCLeverenZonderFatca']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//EmailVrijgaveCBCLeverenZonderFatca.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//EmailVrijgaveCBCLeverenZonderFatca.Aanhef"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveCBCLeverenZonderFatca.ReleaseStatus"/>


          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveCBCLeverenZonderFatca.Mogelijkheid"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//EmailVrijgaveCBCLeverenZonderFatca.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
     ...
     <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveCBCLeverenZonderFatca']" mode="plaintext">

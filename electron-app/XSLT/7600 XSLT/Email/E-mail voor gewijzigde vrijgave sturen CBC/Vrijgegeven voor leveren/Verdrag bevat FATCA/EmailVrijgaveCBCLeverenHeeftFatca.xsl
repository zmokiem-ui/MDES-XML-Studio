...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveCBCLeverenHeeftFatca']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//EmailVrijgaveCBCLeverenHeeftFatca.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//EmailVrijgaveCBCLeverenHeeftFatca.Aanhef"/>
          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveCBCLeverenHeeftFatca.ReleaseStatus"/>

          </p>
          <p>
            <xsl:apply-templates select="//EmailVrijgaveCBCLeverenHeeftFatca.Mogelijkheid"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//EmailVrijgaveCBCLeverenHeeftFatca.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
     ...
     <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailVrijgaveCBCLeverenHeeftFatca']" mode="plaintext">

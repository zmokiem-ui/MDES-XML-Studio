...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='BerichtBeoordelingAanvraagVersturenOK']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenOK.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenOK.Aanhef"/></p>
          <p>
            <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenOK.AanvraagToegekendVoor"/>
          </p>
          <p>
          	<xsl:apply-templates  select="//BerichtBeoordelingAanvraagVersturenOK.AcknowledgementNumber" /> :
          	<xsl:apply-templates  select="//cas:property[cas:key='originelecaseid']/cas:value" /><br />
            <xsl:apply-templates  select="//BerichtBeoordelingAanvraagVersturenOK.FormalName" /> :
            <xsl:apply-templates  select="//cas:property[cas:key='FormeleNaam']/cas:value" /><br />
            <xsl:apply-templates  select="//BerichtBeoordelingAanvraagVersturenOK.mailTaxIdentification" /> :
            <xsl:apply-templates  select="//cas:property[cas:key='CRIB_nummer']/cas:value" /><br />
			<xsl:if test="//cas:property[cas:key='TypeOfCbCAccount']/cas:value = 'RE'">
			  GIIN-nummer: <xsl:apply-templates  select="//cas:property[cas:key='GIIN']/cas:value" />
			</xsl:if>
          </p>
          <p>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='BerichtBeoordelingAanvraagVersturenOK']" mode="plaintext">

      <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenOK.Titel"/>
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenOK.Aanhef"/>
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenOK.AanvraagToegekendVoor"/>
      <xsl:text xml:space="preserve">
      ...
      <xsl:apply-templates  select="//cas:property[cas:key='CRIB_nummer']/cas:value" />
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates  select="//cas:property[cas:key='GIIN']/cas:value" />
      <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenOK.OmInTeLoggen"/>
      <xsl:text xml:space="preserve">

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='BerichtBeoordelingAanvraagVersturenNOK']" mode="content">
        <tr class="header">
        ...
        <td class="title"><xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.Titel" /></td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.Aanhef"/></p>
          <p>
            <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.AanvraagVoorGebruik"/>
          </p>
          <p>
            <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.NieuwAccountMaken"/>
          </p>
          <p class="buttonlink">
            <a>
              ...
              &#32;&#32;&#32;&#32;&#32;&#32;
              <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
            </a>
          </p>
          <p>
            <span class="highlight"
              ><xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.Toelichting"/></span
            >
          </p>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='BerichtBeoordelingAanvraagVersturenNOK']" mode="plaintext">

      <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.Titel"/>
        <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.Aanhef"/>
        <xsl:text xml:space="preserve">
      </xsl:text>
      <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.AanvraagVoorGebruik"/>
        <xsl:text xml:space="preserve">
      ...
      <xsl:apply-templates select="//BerichtBeoordelingAanvraagVersturenNOK.Toelichting"/>
        <xsl:text xml:space="preserve">
      </xsl:text>

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailStatusMessagesVoorIGAAccepted']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
          <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.NotificatieOntvangen"/>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.Verdrag"/> <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" /></span>
          </p>
          <br />
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.OntvangenVan"/>
            ...
            ><br />
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.Status"/>
            <span class="highlight"
          ...
          <br />
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.NotificatieOpgeslagen"/>
            <br />
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.KlikInTeZien"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailStatusMessagesVoorIGAAccepted']" mode="plaintext">
...
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.NotificatieOntvangen"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.Verdrag"/> <xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGAAccepted.OntvangenVan"/>
<xsl:text xml:space="preserve">

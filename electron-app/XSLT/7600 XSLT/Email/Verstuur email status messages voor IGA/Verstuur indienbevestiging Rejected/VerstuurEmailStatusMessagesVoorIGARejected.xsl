...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailStatusMessagesVoorIGARejected']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
         <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.Titel"/>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.Aanhef"/>
           <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.NotificatieOntvangen"/>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.Verdrag"/> <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" /></span>
          </p>
          <br />
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.OntvangenVan"/>
            ...
            ><br />
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.Status"/>
            <span class="highlight"
          ...
          <br />
          <p>
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.NotificatieOpgeslagen"/>
            <br />
            <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.KlikInTeZien"/>
          </p>
          <p class="buttonlink">
            <a>
              <xsl:attribute name="href"><xsl:apply-templates select="//cas:property[cas:key='PortaalNotificatiesLink']/cas:value"/></xsl:attribute>
              &#32;&#32;&#32;&#32;&#32;&#32;
              <xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;</a
            >
          </p>
        </td>
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurEmailStatusMessagesVoorIGARejected']" mode="plaintext">
...
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.Verdrag"/> <xsl:apply-templates  select="//cas:property[cas:key='Verdrag']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurEmailStatusMessagesVoorIGARejected.OntvangenVan"/>
<xsl:text xml:space="preserve">

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='ExportCBCReady']" mode="content">
        <tr class="header">
        ...
        <td class="title">
          <xsl:apply-templates select="//ExportCBCReady.Titel"/>
        </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p>
          <xsl:apply-templates select="//ExportCBCReady.Aanhef"/>
          </p>
          <p>
            <xsl:apply-templates select="//ExportCBCReady.FilesReady"/>
          </p>
	      	<ul>
	      		<xsl:apply-templates select="//cas:property[cas:key='FileNames']/cas:value"/>     		      	
	      	</ul>

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurOntvangstberichtEmailCBCMetVerdrag']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
         <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.Titel" />  
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.Aanhef"/>   <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
          <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.IngediendBijAuthoriteit"/>  
            
          </p>
          <p>
          <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.Verdrag"/>  
            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Verdragen']/cas:value" mode="translate-value" /></span>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.DatumIngediend"/>  
          ...
          <p>
          <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.TypeLevering"/>  
            
            <span class="highlight"
              ><xsl:apply-templates  select="//cas:property[cas:key='TypeLevering']/cas:value" mode="translate-value" /></span
            ><br />
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.Belastingjaar"/>  
            
            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Belastingjaar']/cas:value" /></span>
          </p>
          <p>
          <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.IngediendBijAuthoriteitDoorgegeven"/>  
            
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.IngeslotenPDF"/>  
          ...
          <p class="buttonlink">
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.OpenPortaal"/>  
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
          <p>
            <span class="highlight">
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.Belangrijk"/> 
            </span>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.Informatie"/> 
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    </xsl:template>
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurOntvangstberichtEmailCBCMetVerdrag']" mode="plaintext">

<xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.Titel"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.Aanhef"/>   <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCMetVerdrag.IngediendBijAuthoriteit"/>
<xsl:text xml:space="preserve">

...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurOntvangstberichtEmailCBCZonderVerdrag']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title"><xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.Titel"/>  </td>
      ...
      <tr>
        ...
        <td class="text-highlight">
          <p><xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.IngediendBijAuthoriteit"/> 
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.DatumIngediend"/> 
            <span class="highlight"
              ><xsl:apply-templates  select="//cas:property[cas:key='DatumIngediendFormaat']/cas:value" /></span
            >
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.TypeLevering"/> 
            <span class="highlight"
              ><xsl:apply-templates  select="//cas:property[cas:key='TypeLeveringLabelNL']/cas:value" /></span
            ><br />
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.Belastingjaar"/> 
            <span class="highlight"><xsl:apply-templates  select="//cas:property[cas:key='Belastingjaar']/cas:value" /></span>
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.IngediendBijAuthoriteitDoorgegeven"/> 
          </p>
          <p>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.IngeslotenPDF"/>
          </p>
          <p class="buttonlink">
            <a>
            ...
            &#32;&#32;&#32;&#32;&#32;&#32;
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.OpenPortaal"/>
              &#32;&#32;&#32;&#32;&#32;&#32;&#160;
              </a>
          </p>
          <p>
            <span class="highlight">
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.Belangrijk"/>
            </span>
            <xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.Informatie"/>
          </p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
    </xsl:template>
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='VerstuurOntvangstberichtEmailCBCZonderVerdrag']" mode="plaintext">


<xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.Titel"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.Aanhef"/> <xsl:apply-templates  select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//VerstuurOntvangstberichtEmailCBCZonderVerdrag.IngediendBijAuthoriteit"/>
<xsl:text xml:space="preserve">

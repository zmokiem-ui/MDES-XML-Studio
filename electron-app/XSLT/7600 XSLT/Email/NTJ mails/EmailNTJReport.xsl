...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailNTJReport']" mode="content">
        <tr class="header">
        <td width="55" class="logo">
         ...
         <td class="title">
				...
				<xsl:apply-templates select="//EmailNTJReport.Titel"/>  
			</td>
      ...
      <tr>
        ...
        <td class="text-highlight">
        	<p>
        		<xsl:apply-templates select="//EmailNTJReport.Aanhef" />
        		<xsl:apply-templates select="//cas:property[cas:key='NaamContactpersoon']/cas:value" />,</p>
        	<p>
        		

				<xsl:apply-templates select="//EmailNTJReport.Afgerond"/>  
			...
			<xsl:apply-templates select="//EmailNTJReport.OpenPortaalVoorResultaat"/>  
        	...
        	<p class="buttonlink">
        		<a>
        			...
        			&#32;&#32;&#32;&#32;&#32;&#32;
					<xsl:apply-templates select="//EmailNTJReport.OpenPortaal"/>  
					&#32;&#32;&#32;&#32;&#32;&#32;&#160;
        		</a></p>
        	<p>
			
			<xsl:apply-templates select="//EmailNTJReport.DocumentenOpgeslagen"/>  
			</p>
        </td>
        <td width="55" class="col3">&#32;</td>
      </tr>
	...
	<xsl:template match="*[//cas:property[cas:key='MailIdentifier']/cas:value='EmailNTJReport']" mode="plaintext">
...
<xsl:apply-templates select="//EmailNTJReport.Verdrag"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='Verdrag']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//EmailNTJReport.Jurisdictie"/>
<xsl:text xml:space="preserve">
      </xsl:text>
...
<xsl:apply-templates select="//EmailNTJReport.TypeLevering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//cas:property[cas:key='TypeLeveringLabelNL']/cas:value" />
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//EmailNTJReport.Levering"/>
<xsl:text xml:space="preserve">
      </xsl:text>
<xsl:apply-templates select="//EmailNTJReport.OpenPortaalVoorResultaat"/>
<xsl:text xml:space="preserve">

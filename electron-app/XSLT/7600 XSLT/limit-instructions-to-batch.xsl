			...
			<cas:eventResponse>
				...
				<cas:dataset id="MetaData">
		        	...
		        	<cas:property>
			            ...
			            <cas:value><xsl:value-of select="count(//*[value = 'AccountReport'])"/></cas:value>
			        </cas:property>
			        <cas:property>
			            <cas:key>NrOfReportingFIs</cas:key>
			            <cas:value><xsl:value-of select="count(//*[value = 'ReportingFI'])"/></cas:value>
			        </cas:property>
			        <cas:property>
			            <cas:key>TotalNrOfInstructions</cas:key>
			            <cas:value><xsl:value-of select="count(*/*)"/></cas:value>
			        </cas:property>
			        <cas:property>
			            <cas:key>NextBatch</cas:key>
			            <cas:value><xsl:value-of select="$BatchNumber + 1"/></cas:value>
			        </cas:property>	
			        	        		           
		   		</cas:dataset>
				 
				<xsl:copy-of select="*/*[position() &lt;= $BatchSize]"/>
